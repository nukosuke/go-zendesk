...
func (m *Client) GetTheme(arg0 context.Context, arg1 string) (zendesk.Theme, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTheme", arg0, arg1)
	ret0, _ := ret[0].(zendesk.Theme)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTheme indicates an expected call of GetTheme.
func (mr *ClientMockRecorder) GetTheme(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTheme", reflect.TypeOf((*Client)(nil).GetTheme), arg0, arg1)
}

// GetThemes mocks base method.
func (m *Client) GetThemes(arg0 context.Context, arg1 *zendesk.ThemeListOptions) ([]zendesk.Theme, error) {
	m.ctrl.T.Helper()
...
func (mr *ClientMockRecorder) GetThemes(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetThemes", reflect.TypeOf((*Client)(nil).GetThemes), arg0, arg1)
}
